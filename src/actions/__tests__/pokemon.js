...
import { POKEAPI_ROOT_URL, POKEAPI_POKEMON_URL } from '../../constants/services';

const middlewares = [thunk];
const mockStore = configureMockStore(middlewares);

test('#actions/pokemon', () => {
  test('#fetchPokemonSuccess', () => {
    it('returns an simple action creator', () => {
      const result = pokemonActions.fetchPokemonSuccess();
  ...
  test('#fetchPokemon', () => {
    ...
    it('reurns a thunk action', () => {
      const result = pokemonActions.fetchPokemon();
